...
<body>
    ...
    <section class="equipamento">
        <form class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-md-6">
                <label for="validationCustom03" class="form-label">Nº de Série</label>
                <input type="text" class="form-control" id="validationCustom03" required>
                <div class="invalid-feedback">
                    Please provide a valid city.
                </div>
            ...
            <div class="col-md-6">
                <label for="validationCustom03" class="form-label">Código Hash</label>
                <input type="text" class="form-control" id="validationCustom03" required>
                <div class="invalid-feedback">
                    Please provide a valid city.
                </div>
            ...
            <div class="col-md-6">
                <label for="validationCustom03" class="form-label">Usuário</label>
                <input type="text" class="form-control" id="validationCustom03" required>
                <div class="invalid-feedback">
                    Please provide a valid city.
                </div>
